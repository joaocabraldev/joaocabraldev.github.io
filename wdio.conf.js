exports.config = {
  ...
  // working
  // directory is where your package.json resides, so `wdio` will be called
  // from there.
  //
  specs: [
    './tests/specs/**/*.js',
  ...
  // time. Let's
  // say you have 3 different capabilities (Chrome, Firefox, and Safari) and
  // you have
  // set maxInstances to 1; wdio will spawn 3 processes. Therefore, if you have
  // 10 spec
  // files and you set maxInstances to 10, all spec files will get tested at
  // the same time
  ...
  mochaOpts: {
    ui: 'bdd',
    timeout: 60000,
    require: ['@babel/register', 'common.js/'],
  },
  //
  // =====
  // Hooks
  ...
  /**
     ...
     * to all global
     * variables like `browser`. It is the perfect place to define custom
     * commands.
     * @param {Array.<Object>} capabilities list of capabilities details
     * @param {Array.<String>} specs List of spec file paths that are to be run
     */
  ...
  // },
  /**
     * Hook that gets executed _after_ a hook within the suite starts
     * (e.g. runs after calling
     * afterEach in Mocha)
     */
  ...
  // },
  /**
     * Gets executed after all tests are done. You still have access to
     * all global variables from
     * the test.
